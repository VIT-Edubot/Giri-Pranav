...
const employees = [
    { id: 4, name: "Diana White", position: "HR Manager", department: "Human Resources", isActive: false },
    { id: 1, name: "Alice Johnson", position: "Software Engineer", department: "Development", isActive: true },
    { id: 3, name: "Charlie Brown", position: "Designer", department: "UI/UX", isActive: true },
    { id: 2, name: "Bob Smith", position: "Product Manager", department: "Product", isActive: false },
    { id: 5, name: "Ethan Green", position: "DevOps Engineer", department: "Infrastructure", isActive: true }
];
